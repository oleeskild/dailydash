...
export default {
  ...
  data() {
    return {
      ...
      url:
        "https://www.fitbit.com/oauth2/authorize?response_type=token&client_id=22BB9N&redirect_uri=https%3A%2F%2Fole.dev%2Fdash%3A8080&scope=activity%20heartrate%20location%20nutrition%20profile%20settings%20sleep%20social%20weight&expires_in=604800"
    };
  },
  mounted: function(){
